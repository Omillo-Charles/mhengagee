          ...
          <div className="relative min-h-[360px] overflow-hidden sm:min-h-[500px] lg:min-h-full">
            ...
            <div className="absolute bottom-0 left-0 right-0 z-10 p-6 text-white sm:p-10">
              ...
              <p className="mt-5 max-w-md text-sm leading-7 text-white/75">
                The more we understand, the more accurately we can shape a
                useful quote for your project.
              </p>
            </div>
          </div>
            ...
            {submitted ? (
              <div className="flex min-h-[620px] flex-col justify-center">
                ...
                <p className="mt-4 max-w-md text-sm leading-7 text-black/65">
                  Thanks for sharing the details. This quote form is ready to
                  connect to the email and estimation workflow when the backend
                  is wired up.
                </p>
                <button
                  type="button"
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="border-b border-black/10 pb-6">
                  ...
                  <p className="mt-3 max-w-xl text-sm leading-6 text-black/55">
                    No detail is too early. Share what you know and we&apos;ll
                    ask about the rest.
                  </p>
                </div>
                <div>
                  <p className="quote-step">
                    01 <span>Your details</span>
                  </p>
                  <div className="grid gap-6 sm:grid-cols-2">
                    <label className="block">
                      <span className="quote-field-label">Your name</span>
                      <input
                        required
                        name="name"
                        type="text"
                  ...
                  <div className="grid gap-6 sm:grid-cols-2">
                    <label className="block">
                      <span className="quote-field-label">Email address</span>
                      <input
                        required
                        name="email"
                        type="email"
                ...
                <div>
                  <p className="quote-step">
                    02 <span>Project basics</span>
                  </p>
                  <div className="grid gap-6 sm:grid-cols-2">
                    <label className="block">
                      <span className="quote-field-label">Service needed</span>
                      <select
                        required
                        name="service"
                        defaultValue=""
                  ...
                  <div className="grid gap-6 sm:grid-cols-2">
                    ...
                    <label className="block">
                      <span className="quote-field-label">Location</span>
                      <input
                        name="location"
                        type="text"
                ...
                <div>
                  <p className="quote-step">
                    03 <span>Tell us about the work</span>
                  </p>
                  <label className="block">
                    <span className="quote-field-label">
                    ...
                    <textarea
                      ...
                      name="brief"
                      rows={5}
                      placeholder="Tell us about the project, audience, goals, deliverables, references, and anything else that will help us understand the work."
                      className="quote-field-input resize-none"
                    />
                  </label>
                ...
                <div className="flex flex-col gap-4 border-t border-black/10 pt-6 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    <p className="max-w-sm text-xs leading-5 text-black/45">
                      We&apos;ll review your brief and follow up with the right
                      next steps.
                    </p>
                    {errorMessage && (
