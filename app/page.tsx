  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f5f4f0] selection:bg-primary selection:text-white">
      ...
      <section className="relative mx-auto max-w-[1440px] px-4 pb-14 pt-2 sm:px-8 sm:pb-20 sm:pt-4 lg:px-12 lg:pt-6">
        <section
          className="border-t border-black/10 pt-4 lg:pt-8"
        ...
        >
          <div className="grid overflow-hidden rounded-[2px] bg-navy text-white lg:grid-cols-[0.85fr_1.15fr]">
            ...
            <div className="flex flex-col justify-center p-5 sm:p-10 lg:p-14">
              ...
              <p className="mt-5 max-w-xl text-sm leading-7 text-white/65 sm:mt-6">
                MhengaGee Media helps people, brands, and organizations turn
                ideas into clear, compelling visual stories.
              </p>
                ...
                {[
                  {
                    icon: Camera,
                    title: "Photography",
                    text: "Portraits, events, products, and campaigns.",
                  },
                  {
                    icon: Video,
                    title: "Videography",
                    text: "Films and content that move with purpose.",
                  },
                  {
                    icon: Clapperboard,
                    title: "Cinematography",
                    text: "Visual direction with a distinctive point of view.",
                  },
                  {
                    icon: Mic2,
                    title: "Podcast production",
                    text: "From recording and editing to final delivery.",
                  },
        ...
        <section
          className="mt-16 border-t border-black/10 pt-10 lg:mt-20 lg:pt-14"
        ...
        >
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {services.map((service) => (
              <article
                key={service.slug}
                className="overflow-hidden rounded-[2px] border border-black/10 bg-white transition-shadow duration-300 hover:shadow-[0_18px_45px_rgba(15,23,42,0.12)]"
              >
