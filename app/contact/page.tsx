        ...
        <div className="grid overflow-hidden rounded-[2px] bg-navy text-white lg:grid-cols-[0.9fr_1.1fr]">
          <div className="relative min-h-[420px] overflow-hidden sm:min-h-[560px] lg:min-h-[620px]">
            <Image
              ...
              alt="Glennaspin Opemi, founder of Mhengagee Media"
              fill
              priority
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-9">
              ...
              <p className="mt-4 font-display text-3xl font-bold uppercase leading-[0.95] sm:text-4xl">
                Stories made with purpose.
              </p>
            </div>
          </div>
          <div className="flex flex-col justify-center p-6 sm:p-10 lg:p-14">
            ...
            <div className="mt-8 space-y-5 font-sans text-base leading-7 text-white/70">
              <p>
                Glennaspin Opemi, widely known as Mhenga, began his media career
                at the Cooperative University of Kenya, where his curiosity for
                storytelling grew into a life in visual media.
              </p>
              <p>
                He is the founder and producer at Mhengagee Media, a media
                personality at CUK, and a host, videographer, and photographer
                at DSM Studios in Nairobi, Kenya.
              </p>
              <p>
                Through his work, Glennaspin brings people, ideas, and real
                moments into focus, creating photography and video that feels
                immediate, thoughtful, and distinctly human.
              </p>
            </div>
      ...
      <section className="mx-auto max-w-[1440px] px-5 pb-16 pt-8 sm:px-8 sm:pt-12 lg:px-12 lg:pt-16">
        <div className="grid overflow-hidden rounded-[2px] bg-white shadow-[0_18px_60px_rgba(15,23,42,0.08)] lg:grid-cols-[0.9fr_1.1fr]">
          <div className="relative min-h-[380px] overflow-hidden bg-navy sm:min-h-[520px] lg:min-h-[720px]">
            <Image
              ...
              alt="Mhengagee Media portrait"
              fill
              priority
              className="object-cover object-[72%_center] transition duration-700 hover:scale-105"
              sizes="(max-width: 1024px) 100vw, 45vw"
            />
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 text-white sm:p-9">
              ...
              <p className="mt-4 max-w-sm font-display text-3xl font-bold uppercase leading-[0.95] sm:text-4xl">
          ...
          <div className="bg-navy p-5 text-white sm:p-9 lg:p-12">
            ...
            {submitted ? (
              <div className="flex min-h-[400px] flex-col items-start justify-center">
                ...
                <p className="mt-3 max-w-md font-sans text-sm leading-6 text-white/65">
                  Thanks for reaching out. This form is ready to connect to the
                  admin inbox when the backend is wired up.
                </p>
                <button
                  type="button"
              ...
              <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                <div className="grid gap-6 sm:grid-cols-2">
                  <label className="block">
                    ...
                    <input
                      ...
                      name="name"
                      type="text"
                      className="mt-2 w-full border-b border-white/20 bg-transparent px-0 py-3 font-sans text-sm text-white outline-none transition-colors placeholder:text-white/30 focus:border-accent-cyan"
                ...
                <label className="block">
                  ...
                  <select
                    name="service"
                    defaultValue=""
                    className="mt-2 w-full border-b border-white/20 bg-navy px-0 py-3 font-sans text-sm text-white outline-none transition-colors focus:border-accent-cyan"
                  >
                ...
                <label className="block">
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={5}
                    className="mt-2 w-full resize-none border-b border-white/20 bg-transparent px-0 py-3 font-sans text-sm text-white outline-none transition-colors placeholder:text-white/30 focus:border-accent-cyan"
                    placeholder="A few details about your idea, timeline, or budget..."
                  />
                </label>
                {errorMessage && (
        ...
        <div className="mt-8 grid gap-4 border-t border-black/10 pt-8 sm:grid-cols-2 lg:grid-cols-4">
          <a
            ...
            className="group flex items-center gap-3 rounded-[2px] bg-white p-5 transition-shadow hover:shadow-[0_10px_30px_rgba(15,23,42,0.08)]"
          >
            <span className="flex h-10 w-10 items-center justify-center rounded-full bg-navy text-accent-cyan">
              <Mail size={17} />
            </span>
            <span>
          ...
          <a
            href="https://www.youtube.com/@DSMUpdates"
            target="_blank"
            rel="noreferrer"
            className="group flex items-center gap-3 rounded-[2px] bg-white p-5 transition-shadow hover:shadow-[0_10px_30px_rgba(15,23,42,0.08)]"
          >
