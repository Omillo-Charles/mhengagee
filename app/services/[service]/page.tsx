  ...
  return (
    <main className="min-h-screen bg-[#f5f4f0] text-navy selection:bg-primary selection:text-white">
      <article className="mx-auto max-w-[1400px] px-5 pb-20 pt-8 sm:px-8 lg:px-12 lg:pt-12">
        ...
        <section
          className="mt-20 grid gap-10 border-t border-black/10 pt-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20"
          ...
          <div className="max-w-2xl text-base leading-8 text-black/65">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {details.benefits.map((benefit) => (
                <p
                  key={benefit}
                  className="border-t border-black/10 pt-4 text-sm leading-6 text-navy"
                >
                  {benefit}
                </p>
              ))}
        ...
        <section
          className="mt-20 grid gap-10 bg-navy p-6 text-white sm:p-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20 lg:p-14"
        ...
        >
          ...
          <ul className="grid gap-4 sm:grid-cols-2">
            {details.deliverables.map((deliverable, index) => (
              <li
                key={deliverable}
                className="border-t border-white/15 pt-4 text-sm leading-6 text-white/70"
              >
                <span className="mr-3 font-accent text-[10px] text-accent-yellow">
                  0{index + 1}
                </span>
                {deliverable}
              </li>
        ...
        <section
          className="mt-20 grid gap-10 border-t border-black/10 pt-12 lg:grid-cols-2"
        ...
        >
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {details.bestFor.map((item) => (
              <div
                key={item}
                className="border border-black/10 bg-white p-5 text-sm leading-6 text-navy"
              >
                {item}
              </div>
            ))}
