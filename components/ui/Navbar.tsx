...
export default function Navbar() {
    ...
    return (
        <header className="sticky top-0 z-50 border-b border-black/10 bg-white/95 backdrop-blur-md">
            ...
            <nav className="mx-auto flex max-w-[1440px] items-center justify-between gap-8 px-5 py-2 sm:px-8 lg:px-12 lg:py-3" aria-label="Main navigation">
                <Link href="/" className="group flex shrink-0 items-center gap-3">
                    <span className="relative h-11 w-11 overflow-hidden rounded-md bg-white transition-transform duration-300 group-hover:scale-105" aria-hidden="true">
                        <Image
                    ...
                    <span className="flex flex-col leading-none text-[var(--brand-navy)]">
                        <span className="font-display text-lg font-bold uppercase tracking-[0.14em]">MHENGAGEE</span>
                        <span className="mt-1 font-accent text-[10px] font-semibold uppercase tracking-[0.42em] text-[var(--brand-primary)]">Media</span>
                    </span>
                </Link>
