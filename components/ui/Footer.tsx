      ...
      <div className="mx-auto max-w-[1440px] px-5 pb-6 pt-14 sm:px-8 sm:pt-16 lg:px-12 lg:pt-20">
        <div className="grid gap-12 border-b border-white/15 pb-12 sm:grid-cols-2 lg:grid-cols-[1.15fr_0.7fr_1fr] lg:gap-20 lg:pb-16">
          <div>
            ...
            <p className="mt-6 max-w-sm font-accent text-sm leading-7 text-white/55">
            ...
            <div className="mt-7 flex flex-wrap gap-x-6 gap-y-3 font-accent text-[10px] font-semibold uppercase text-white/65">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="transition-colors hover:text-[var(--brand-accent-cyan)]"
              >
                Instagram
              </a>
              <a
            ...
            <div className="mt-5 grid grid-cols-2 gap-x-8 gap-y-4 sm:grid-cols-1 sm:gap-y-3">
              {navigation.map((item) => (
                <Link
                  key={item.label}
                  href={item.href}
                  className="group flex items-center gap-2 font-display text-lg text-white/80 transition-colors hover:text-white"
                >
                  {item.label}
                  <ArrowUpRight
                    size={14}
          ...
          <div id="contact">
            ...
            <div className="mt-5 space-y-4">
              <a
                href="mailto:hello@mhengagee.co.ke"
                className="flex items-center gap-3 font-accent text-sm text-white/80 transition-colors hover:text-[var(--brand-accent-cyan)]"
              >
                <Mail
                  size={16}
                  strokeWidth={1.7}
                  className="text-[var(--brand-accent-cyan)]"
                />
                hello@mhengagee.co.ke
              </a>
              <span className="flex items-center gap-3 font-accent text-sm text-white/65">
                <MapPin
                  size={16}
                  strokeWidth={1.7}
                  className="text-[var(--brand-accent-cyan)]"
        ...
        <div className="flex flex-col gap-4 border-t border-white/15 pt-5 font-accent text-[10px] uppercase text-white/40 sm:flex-row sm:items-center sm:justify-between">
          ...
          <span>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-white/70 transition-colors hover:text-[var(--brand-accent-cyan)]"
            >
              OMYT3CH
            </a>
          </span>
          <div className="flex items-center gap-4">
            ...
            >
              Back to top <Send size={13} strokeWidth={1.7} />
            </Link>
          </div>
        </div>
      </div>
