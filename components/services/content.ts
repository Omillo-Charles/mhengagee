...
export const services: Service[] = [
  {
    ...
    title: "Photography",
    description:
      "Portraits, events, products, and campaigns shaped with clarity and character.",
  ...
  },
  {
    ...
    title: "Videography",
    description:
      "Purposeful video content for brands, people, and moments that deserve to move.",
  ...
  },
  {
    ...
    description:
      "Visual direction with a distinctive point of view, from the first frame to the final cut.",
  ...
  },
  {
    ...
    description:
      "Recording, editing, and finishing conversations that sound as good as they feel.",
  ...
  },
  {
    ...
    title: "Branding",
    description:
      "A coherent visual presence that helps your work become recognizable and remembered.",
  ...
  },
  {
    ...
    description:
      "A sensitive, energetic record of the people and details that make an event matter.",
